...
let idade = 25; //var vai poder guardar 2 tipos de valores
let generico = []; //qnd há um extenso ou não sabe o valor da var
generico = {
    a: '',
    b: 8,
    c: true
...
const listaDeNomes = ['João Pedro', 'César', 'Vitor'];
listaDeNomes.push('Roberta');
const valores = ['azul', 55]; //generico informa p o objeto que ele vai trabalhar com um tipo de dado
